...
namespace PlanetGeneration
{
    ...
    public partial class SolarSystemGenerator : MonoBehaviour
    {
        ...
        void ApplyPlanetVisualProfile(PlanetEntry p)
        {
            ...
            RenderSettings.fogDensity = Mathf.Lerp(0.00075f, 0.00018f,
            ...
            for (int i = 0; i < planetCount; i++)
            {
                ...
                if (useRandomColors && !forceStarterLush)
                {
                    biome = new BiomePreset("Procedural",
                        Random.ColorHSV(0f, 1f, 0.5f, 1f, 0.1f, 0.4f),
                        Random.ColorHSV(0f, 1f, 0.4f, 0.9f, 0.5f, 0.9f),
                        Random.ColorHSV(0f, 1f, 0.1f, 0.6f, 0.5f, 0.9f),
                        Random.ColorHSV(0f, 1f, 0.3f, 0.9f, 0.3f, 0.7f),
                        Random.ColorHSV(0f, 1f, 0.4f, 1.0f, 0.1f, 0.4f),
                        Random.ColorHSV(0f, 1f, 0.0f, 0.4f, 0.2f, 0.6f),
                        Random.ColorHSV(0f, 1f, 0.0f, 0.2f, 0.8f, 1.0f),
                        Random.ColorHSV(0f, 1f, 0.3f, 0.8f, 0.5f, 1.0f));
                    biome.atmo.a = Random.Range(0.35f, 0.65f);
                }
                else
                {
                    biome = forceStarterLush
                        ? Biomes[Random.Range(0, 2) == 0 ? 0 : 5]
                                      ...
                                      BiomePreset biome, bool hasOcean, bool hasTrees, bool forceStarterLush)
        {
            ...
            pg.planetSettings.maxHeightRatio = forceStarterLush ? Random.Range(0.13f, 0.18f) : Random.Range(0.15f, 0.24f);
