...
namespace PlanetaryRendering.Atmosphere
{
    ...
    public class AtmosphereController : MonoBehaviour
    {
        ...
        void Update()
        {
            if (planet == null || player == null || atmosphereMaterial == null) return;
            ...
            float t = Mathf.Clamp01(height / atmosphereHeight);

            float target = maxIntensity * (1f - t);
            ...
            currentIntensity = Mathf.Lerp(currentIntensity, target, 1f - Mathf.Exp(-fadeSpeed * Time.deltaTime));
