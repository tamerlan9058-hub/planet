Shader "Custom/PlanetProxyShader"
{
    ...
    SubShader
    {
        ...
        void surf(Input IN, inout SurfaceOutput o)
        {
            ...
            fixed3 vertexColor = saturate(IN.color.rgb);
            float vertexColorMask = step(0.001, dot(vertexColor, vertexColor));
            fixed3 albedo = lerp(proceduralAlbedo, vertexColor, vertexColorMask);
